...
for.body:                                         ; preds = %for.cond
  ...
  %div1 = udiv i64 %2, 1
  store i64 %div1, i64* %i, align 8
  %3 = load i64, i64* %i, align 8
  %div2 = udiv i64 %3, 1
  store i64 %div2, i64* %i, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_prog.cpp() #0 section ".text.startup" {
entry:
...
!1 = !{!"clang version 11.0.0 (https://github.com/llvm/llvm-project.git b8cbff51d39b1f96d827adac569b8a64200ea7bb)"}
